  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-10">
      ...
      <section className="mx-auto grid max-w-5xl grid-cols-1 gap-10 md:grid-cols-2">
        <div className="flex flex-col justify-center">
          ...
          <p className="mt-6 text-base leading-relaxed text-gray-700">
            SnowSwap is a new service introduced by Snowminds with a clear purpose: to make it easier and safer to give ski gear a second life. The platform is built on the idea that quality equipment doesn’t lose its value after one season and that resale should be just as trustworthy and simple as buying new. In an industry where large amounts of gear are produced and replaced every year, much of it still has plenty of life left. SnowSwap aims to reduce waste by extending the lifespan of ski clothing and equipment, while offering a transparent and curated alternative to traditional resale platforms. By focusing on quality, condition, and ease of use, SnowSwap supports a more circular approach to ski culture without compromising on performance or trust.
          </p>
        </div>
      ...
      <section className="mx-auto grid max-w-5xl grid-cols-1 gap-10 md:grid-cols-2">
        {/* Row 2 image */}
        <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl bg-gray-100">
          <Image src="/jacket.png" alt="Fit and conditions" fill className="object-cover object-top" />
        </div>
